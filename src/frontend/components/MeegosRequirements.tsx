...
import { useHandleValidateMeeListRules } from "../handlers/useHandleValidateMeeListRules";
import { getRuleText } from "@/pages/project/[projectSlug]/giveaway/[giveawaySlug]";

export const MeegosRequirements = ({
  ...
  const handleRules = useHandleValidateMeeListRules();
      ...
      <div className="w-full md:w-96 backdrop-blur bg-dark-600/40  md:top-12 rounded-lg p-3">
        ...
        {rules.map((rule, ruleIdx) => (
          <RequirementRow
            ...
            hasBottomBorder={ruleIdx !== rules.length - 1}
          >
            <div>

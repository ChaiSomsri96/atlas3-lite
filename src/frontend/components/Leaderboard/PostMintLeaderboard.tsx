...
export const PostMintLeaderboard = ({ search }: Props) => {
    ...
    <div className="w-full">
      <div className="bg-primary-900 px-6 py-4 flex flex-col-reverse md:flex-row gap-4 rounded-xl mt-6">
        ...
        <div className="flex flex-col">
          <p className="">- Votes for post-mint projects are permanant.</p>
          <p className="">
            - The top 3 projects get a badge on their project to signal that
            they are trending.
          </p>
        </div>

...
import { NonVerifiedProjectsResp } from "@/frontend/hooks/useNonVerifiedProjects";

export const SearchNonVerifiedProjects = ({
  allProjects,
  setValue,
}: {
  allProjects: NonVerifiedProjectsResp | undefined;
  ...
  return (
    <div>
      <Menu as="div" className="relative" ref={searchRef}>
        ...
        >
          <Menu.Items className="absolute right-0 mt-2 w-full origin-top-right rounded-lg bg-dark-800 shadow-lg border border-dark-400">

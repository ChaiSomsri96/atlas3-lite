          ...
          {
            {
              ...
              REJECTED: (
                <div className="flex bg-error-500 text-sm rounded-md items-center gap-1 py-1 px-2 cursor-default">
                  <div className="rounded-full w-3 h-3 bg-white animate-pulse" />
...
export const ApplicationCard = ({
  ...
  return (
    <div className="relative w-full md:w-1/3 min-w-[350px] md:min-w-[400px] h-40 rounded-lg  hover:shadow-[0px_0px_24px_5px_rgba(0,133,234,0.25)] hover:outline outline-primary-500">
      <img
        src={application.project.bannerUrl ?? ""}
        alt="Project Image"
          ...
          <div className="flex mx-4 items-center justify-between">
            <div className="flex items-center gap-3">
              <div
                ...
                onClick={(e) =>
                  openUrl(e, application.project.discordInviteUrl)
                }
              >
              ...
              <div
                ...
                onClick={(e) =>
                  openUrl(
                    e,
                    `https://twitter.com/${application.project.twitterUsername}`
                  )
                }
              >
            ...
            <WhitelistStatusBadge
              status={application.submissions[0]?.status ?? "none"}
